...
public class ProfesorDeProgramacion extends Profesor implements Programador{
    ...
    public ProfesorDeProgramacion(int aniosExperiencia, String lenguajeDeProgramacion, String carrera, int antiguedad, String nomre, int nombre) {
        super(carrera, antiguedad, nomre, nombre);
        this.aniosExperiencia = aniosExperiencia;
        this.lenguajeDeProgramacion = lenguajeDeProgramacion;
    }
